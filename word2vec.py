...
# print("保存模型中")
# xtrain_w2v=joblib.load( 'models/xtrain_w2v.pkl')
# xvalid_w2v=joblib.load('models/xvalid_w2v.pkl')
# print("保存成功")
...
print(classification_report(yvalid, predictions_process))
